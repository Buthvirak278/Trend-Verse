...
<body class="bg-white text-black">
  ...
  <main class="max-w-7xl mx-auto px-10 flex flex-col md:flex-row gap-10">
    <section class="flex flex-col">
      <img id="mainImage" alt="Backpack Front" class="rounded-md max-w-[600px] w-full" src="https://www.sprayground.com/cdn/shop/files/file_756b4689-7d4a-42a2-8ec6-e6bbbedc3a65.png?v=1748982091"/>
  ...
  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_756b4689-7d4a-42a2-8ec6-e6bbbedc3a65.png?v=1748982091"
      data-src="https://www.sprayground.com/cdn/shop/files/file_756b4689-7d4a-42a2-8ec6-e6bbbedc3a65.png?v=1748982091" 
      alt="Front view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_52014b08-8080-4a7a-a72e-fb6e5789291f.png?v=1748982094"
      data-src="https://www.sprayground.com/cdn/shop/files/file_52014b08-8080-4a7a-a72e-fb6e5789291f.png?v=1748982094" 
      alt="Back view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_98e67547-840d-4505-95f0-b87428bb30bc.png?v=1748982090"
      data-src="https://www.sprayground.com/cdn/shop/files/file_98e67547-840d-4505-95f0-b87428bb30bc.png?v=1748982090" 
      alt="Side view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_189d7d6a-034d-4f2b-ac50-0a6a3afad47d.png?v=1748982097"
      data-src="https://www.sprayground.com/cdn/shop/files/file_189d7d6a-034d-4f2b-ac50-0a6a3afad47d.png?v=1748982097" 
      alt="Inside view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_d87d516c-44d5-40b3-b6b7-9a531f7301d7.jpg?v=1748976837"
      data-src="https://www.sprayground.com/cdn/shop/files/file_d87d516c-44d5-40b3-b6b7-9a531f7301d7.jpg?v=1748976837" 
      alt="Inside view 2" class="rounded-md max-h-full max-w-full object-contain" />
  </div>
    </section>

    <section class="flex flex-col max-w-md">
      <h1 class="text-[18px] font-normal tracking-widest mb-1">ELEGANT BOMBASTIC DLXSV BACKPACK</h1>
      <a class="text-[14px] font-normal text-slate-500 mb-4" href="#">SIZE CHART</a>
      <p class="text-[18px] font-normal mb-6">$90.00</p>
...
<section class="mt-8">
  ...
  <p class="mb-4">Stone washed denim fabric with metallic screen print.</p>

  <h3 class="font-semibold">Exterior</h3>
  ...
  <h3 class="font-semibold">Interior</h3>
  <ul class="list-disc list-inside mb-4">
    <li>Separate velour laptop compartment</li>
    <li>Mesh organizer pocket</li>
  </ul>

  <h3 class="font-semibold">Fabric</h3>
  <p class="mb-4">100% Cotton Twill</p>
</section>
  ...
  <script>
    (() => {
      const PRODUCT_NAME = "ELEGANT BOMBASTIC DLXSV BACKPACK";
      const PRODUCT_PRICE = 90.00;

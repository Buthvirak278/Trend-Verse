...
<body class="bg-white text-black">
  ...
  <main class="max-w-7xl mx-auto px-10 flex flex-col md:flex-row gap-10">
    <section class="flex flex-col">
      <img id="mainImage" alt="Backpack Front" class="rounded-md max-w-[600px] w-full" src="https://www.sprayground.com/cdn/shop/files/file_39db3f87-9f18-4a4e-81f6-6a417d14aa1b.png?v=1748982222"/>
      
      <div class="flex gap-6 mt-6 small-images">
  <button class="border border-black rounded-md p-1 max-w-[100px]">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_39db3f87-9f18-4a4e-81f6-6a417d14aa1b.png?v=1748982222"
      data-src="https://www.sprayground.com/cdn/shop/files/file_39db3f87-9f18-4a4e-81f6-6a417d14aa1b.png?v=1748982222" 
      alt="Front view" class="rounded-md" />
  </button>

  <button class="border border-black rounded-md p-1 max-w-[100px]">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_ad3f2500-3ee8-4e9a-9a6a-0d5213249ba7.png?v=1748982219"
      data-src="https://www.sprayground.com/cdn/shop/files/file_ad3f2500-3ee8-4e9a-9a6a-0d5213249ba7.png?v=1748982219" 
      alt="Back view" class="rounded-md" />
  </button>

  <button class="border border-black rounded-md p-1 max-w-[100px]">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_1ab7e76d-58f2-4606-a11a-0c30a3471b48.png?v=1748981965"
      data-src="https://www.sprayground.com/cdn/shop/files/file_1ab7e76d-58f2-4606-a11a-0c30a3471b48.png?v=1748981965" 
      alt="Side view" class="rounded-md" />
  </button>

  <button class="border border-black rounded-md p-1 max-w-[100px]">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_9f827955-dfba-491f-9837-44652261822c.jpg?v=1748976823"
      data-src="https://www.sprayground.com/cdn/shop/files/file_9f827955-dfba-491f-9837-44652261822c.jpg?v=1748976823" 
      alt="Inside view" class="rounded-md" />
  </button>
  <button class="border border-black rounded-md p-1 max-w-[100px]">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_fa714964-bb13-43f3-8a71-31b5e9a3ea63.jpg?v=1748976823"
      data-src="https://www.sprayground.com/cdn/shop/files/file_fa714964-bb13-43f3-8a71-31b5e9a3ea63.jpg?v=1748976823" 
      alt="Inside view" class="rounded-md" />
  </button>
</div>
    ...
    <section class="flex flex-col max-w-md">
      <h1 class="text-[18px] font-normal tracking-widest mb-1">KITTY KASH: ON THE EDGE DLXR BACKPACK</h1>
      <a class="text-[14px] font-normal text-slate-500 mb-4" href="#">SIZE CHART</a>
      <p class="text-[18px] font-normal mb-6">$70.00</p>
...
<div class="mt-10">
  ...
  <ul class="list-disc list-inside text-[14px] mb-4">
  ...
  <p class="text-[14px] mb-4">900D Polyester Fabric</p>
</div>
  ...
  <script>
    (() => {
      const PRODUCT_NAME = "KITTY KASH: ON THE EDGE DLXR BACKPACK";
      const PRODUCT_PRICE = 70.00;

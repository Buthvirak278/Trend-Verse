...
<body class="bg-white text-black">
  ...
  <main class="max-w-7xl mx-auto px-10 flex flex-col md:flex-row gap-10">
    <section class="flex flex-col">
      <img id="mainImage" alt="Backpack Front" class="rounded-md max-w-[600px] w-full" src="https://www.sprayground.com/cdn/shop/files/file_253b4df6-1e2b-46e0-8bdd-77209b60af4d.png?v=1748981979"/>
  ...
  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_253b4df6-1e2b-46e0-8bdd-77209b60af4d.png?v=1748981979"
      data-src="https://www.sprayground.com/cdn/shop/files/file_253b4df6-1e2b-46e0-8bdd-77209b60af4d.png?v=1748981979" 
      alt="Front view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_b02998ed-7c80-44c7-b1cd-a2e8954cc422.png?v=1748981976"
      data-src="https://www.sprayground.com/cdn/shop/files/file_b02998ed-7c80-44c7-b1cd-a2e8954cc422.png?v=1748981976" 
      alt="Back view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_9d704702-5f3d-48b0-bdc7-cdff84d6d8d6.png?v=1748981977"
      data-src="https://www.sprayground.com/cdn/shop/files/file_9d704702-5f3d-48b0-bdc7-cdff84d6d8d6.png?v=1748981977" 
      alt="Side view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_245a52b7-c64c-440e-abaf-ab297aa1da59.png?v=1748981979"
      data-src="https://www.sprayground.com/cdn/shop/files/file_245a52b7-c64c-440e-abaf-ab297aa1da59.png?v=1748981979" 
      alt="Inside view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_9af0abc5-918c-47c3-a852-bd29faa90a7a.jpg?v=1748976828"
      data-src="https://www.sprayground.com/cdn/shop/files/file_9af0abc5-918c-47c3-a852-bd29faa90a7a.jpg?v=1748976828" 
      alt="Inside view 2" class="rounded-md max-h-full max-w-full object-contain" />
  </div>
    </section>

    <section class="flex flex-col max-w-md">
      <h1 class="text-[18px] font-normal tracking-widest mb-1">PARALLEL UNIVERSE BEAR SHARK DLXR BACKPACK</h1>
...
<section class="product-details mt-8">
  <h2 class="text-xl font-bold mb-4">PRODUCT DETAILS</h2>

  <h3 class="text-lg font-semibold mb-2">Exterior</h3>
  ...
  <h3 class="text-lg font-semibold mb-2">Interior</h3>
  <ul class="list-disc pl-5 mb-4">
  ...
  <script>
    (() => {
      const PRODUCT_NAME = "PARALLEL UNIVERSE BEAR SHARK DLXR BACKPACK";

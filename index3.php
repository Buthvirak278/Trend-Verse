...
<body class="bg-white text-black">
  ...
  <main class="max-w-7xl mx-auto px-10 flex flex-col md:flex-row gap-10">
    <section class="flex flex-col">
      <img id="mainImage" alt="Backpack Front" class="rounded-md max-w-[600px] w-full" src="https://www.sprayground.com/cdn/shop/files/file_37ee2caf-83c9-4a02-a1a8-521c43a43853.png?v=1749493054"/>
  ...
  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_37ee2caf-83c9-4a02-a1a8-521c43a43853.png?v=1749493054"
      data-src="https://www.sprayground.com/cdn/shop/files/file_37ee2caf-83c9-4a02-a1a8-521c43a43853.png?v=1749493054" 
      alt="Front view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_5809a246-41ac-4713-9a73-1e87cd2807aa.png?v=1749493055"
      data-src="https://www.sprayground.com/cdn/shop/files/file_5809a246-41ac-4713-9a73-1e87cd2807aa.png?v=1749493055" 
      alt="Back view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_1d2f0cc7-ca57-450d-a0e7-a0c21a0e4439.png?v=1749493054"
      data-src="https://www.sprayground.com/cdn/shop/files/file_1d2f0cc7-ca57-450d-a0e7-a0c21a0e4439.png?v=1749493054" 
      alt="Side view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_9d6c30d1-70df-408d-b2b4-c0245565f046.png?v=1749493056"
      data-src="https://www.sprayground.com/cdn/shop/files/file_9d6c30d1-70df-408d-b2b4-c0245565f046.png?v=1749493056" 
      alt="Inside view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_299c6ac4-942c-482d-8250-fb7c763ffaa1.png?v=1749493056"
      data-src="https://www.sprayground.com/cdn/shop/files/file_299c6ac4-942c-482d-8250-fb7c763ffaa1.png?v=1749493056" 
      alt="Inside view 2" class="rounded-md max-h-full max-w-full object-contain" />
  </div>
    </section>

    <section class="flex flex-col max-w-md">
      <h1 class="text-[18px] font-normal tracking-widest mb-1">MONOPOLY WHEEL BARREL BACKPACK</h1>
...
<section class="px-6 py-10 bg-gray-50">
  <h2 class="text-2xl font-bold mb-6 border-b pb-2 uppercase">Product Details</h2>
  ...
  <div>
    ...
    <p class="text-gray-700">Durable Faux Leather water-resistant fabric</p>
  </div>
</section>
  ...
  <script>
    (() => {
      const PRODUCT_NAME = "MONOPOLY WHEEL BARREL BACKPACK";

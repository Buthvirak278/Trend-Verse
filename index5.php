...
<body class="bg-white text-black">
  ...
  <main class="max-w-7xl mx-auto px-10 flex flex-col md:flex-row gap-10">
    <section class="flex flex-col">
      <img id="mainImage" alt="Backpack Front" class="rounded-md max-w-[600px] w-full" src="https://www.sprayground.com/cdn/shop/files/file_8be8356f-bd8a-4a6d-a679-432d9749869a.png?v=1748981759"/>
  ...
  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_8be8356f-bd8a-4a6d-a679-432d9749869a.png?v=1748981759"
      data-src="https://www.sprayground.com/cdn/shop/files/file_8be8356f-bd8a-4a6d-a679-432d9749869a.png?v=1748981759" 
      alt="Front view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_dd9664a5-c513-408f-8b82-229a5b2364bc.png?v=1748981757"
      data-src="https://www.sprayground.com/cdn/shop/files/file_dd9664a5-c513-408f-8b82-229a5b2364bc.png?v=1748981757" 
      alt="Back view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_a65fb237-51bd-467b-8af6-f0bd14a34567.png?v=1748981758"
      data-src="https://www.sprayground.com/cdn/shop/files/file_a65fb237-51bd-467b-8af6-f0bd14a34567.png?v=1748981758" 
      alt="Side view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_f479b590-ef6e-4c99-8255-bd27dfff4e30.png?v=1748981762"
      data-src="https://www.sprayground.com/cdn/shop/files/file_f479b590-ef6e-4c99-8255-bd27dfff4e30.png?v=1748981762" 
      alt="Inside view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_155588a3-2c56-40bc-8902-1c8856dfc90c.jpg?v=1748976794"
      data-src="https://www.sprayground.com/cdn/shop/files/file_155588a3-2c56-40bc-8902-1c8856dfc90c.jpg?v=1748976794" 
      alt="Inside view 2" class="rounded-md max-h-full max-w-full object-contain" />
  </div>
    </section>

    <section class="flex flex-col max-w-md">
      <h1 class="text-[18px] font-normal tracking-widest mb-1">HYPESHARK DLX BACKPACK</h1>
      <a class="text-[14px] font-normal text-slate-500 mb-4" href="#">SIZE CHART</a>
      <p class="text-[18px] font-normal mb-6">$120.00</p>
...
<section class="product-details my-8">
  ...
  <div class="mb-6">
    ...
    <p>Durable Faux Leather water-resistant fabric</p>
  </div>
</section>
  ...
  <script>
    (() => {
      const PRODUCT_NAME = "HYPESHARK DLX BACKPACK";
      const PRODUCT_PRICE = 120.00;

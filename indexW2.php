...
<body class="bg-white text-black">
  ...
  <main class="max-w-7xl mx-auto px-10 flex flex-col md:flex-row gap-10">
    <section class="flex flex-col">
      <img id="mainImage" alt="Backpack Front" class="rounded-md max-w-[600px] w-full" src="https://www.sprayground.com/cdn/shop/files/file_289e8cd3-902b-462b-88f1-ac1ee29bdfa8.png?v=1748982083"/>
  ...
  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_289e8cd3-902b-462b-88f1-ac1ee29bdfa8.png?v=1748982083"
      data-src="https://www.sprayground.com/cdn/shop/files/file_289e8cd3-902b-462b-88f1-ac1ee29bdfa8.png?v=1748982083" 
      alt="Front view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_90feace6-c76a-4c32-9bbf-c856e073793b.png?v=1748982085"
      data-src="https://www.sprayground.com/cdn/shop/files/file_90feace6-c76a-4c32-9bbf-c856e073793b.png?v=1748982085" 
      alt="Back view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_38eca754-4e7b-4bdc-b334-b1cd3628380a.png?v=1748982093"
      data-src="https://www.sprayground.com/cdn/shop/files/file_38eca754-4e7b-4bdc-b334-b1cd3628380a.png?v=1748982093" 
      alt="Side view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_2b6b96b9-a604-48bd-a5ee-2e1e3a06d45c.png?v=1748982085"
      data-src="https://www.sprayground.com/cdn/shop/files/file_2b6b96b9-a604-48bd-a5ee-2e1e3a06d45c.png?v=1748982085" 
      alt="Inside view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_71ae321b-77e2-45e7-85a1-29af94aa231f.jpg?v=1748982082"
      data-src="https://www.sprayground.com/cdn/shop/files/file_71ae321b-77e2-45e7-85a1-29af94aa231f.jpg?v=1748982082" 
    ...
    <section class="flex flex-col max-w-md">
      <h1 class="text-[18px] font-normal tracking-widest mb-1">CANDY POP DLXR BACKPACK</h1>
...
<section class="product-details mt-10">
  ...
  <script>
    (() => {
      const PRODUCT_NAME = "CANDY POP DLXR BACKPACK";

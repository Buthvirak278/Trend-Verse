...
<body class="bg-white text-black">
  ...
  <main class="max-w-7xl mx-auto px-10 flex flex-col md:flex-row gap-10">
    <section class="flex flex-col">
      <img id="mainImage" alt="Backpack Front" class="rounded-md max-w-[600px] w-full" src="https://www.sprayground.com/cdn/shop/files/file_e30ad884-ab5e-446a-891f-453b0b4b45e7.png?v=1748982225"/>
  ...
  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_e30ad884-ab5e-446a-891f-453b0b4b45e7.png?v=1748982225"
      data-src="https://www.sprayground.com/cdn/shop/files/file_e30ad884-ab5e-446a-891f-453b0b4b45e7.png?v=1748982225" 
      alt="Front view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_57c96785-2bc9-419a-b4d8-fc0f7f0f5896.png?v=1748982224"
      data-src="https://www.sprayground.com/cdn/shop/files/file_57c96785-2bc9-419a-b4d8-fc0f7f0f5896.png?v=1748982224" 
      alt="Back view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_ec5bb3cd-6528-472c-aece-8ff2b83ac998.png?v=1748982227"
      data-src="https://www.sprayground.com/cdn/shop/files/file_ec5bb3cd-6528-472c-aece-8ff2b83ac998.png?v=1748982227" 
      alt="Side view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_d7069c42-dafe-4327-a68b-ba1fb7e5cdf4.png?v=1748981965"
      data-src="https://www.sprayground.com/cdn/shop/files/file_d7069c42-dafe-4327-a68b-ba1fb7e5cdf4.png?v=1748981965" 
      alt="Inside view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_a266f40f-f07a-4a96-984f-069abca5ac1b.jpg?v=1748976824"
      data-src="https://www.sprayground.com/cdn/shop/files/file_a266f40f-f07a-4a96-984f-069abca5ac1b.jpg?v=1748976824" 
    ...
    <section class="flex flex-col max-w-md">
      <h1 class="text-[18px] font-normal tracking-widest mb-1">ASTROGALAXY DLXSV BACKPACK</h1>
...
<section class="max-w-7xl mx-auto px-10 mt-10">
  ...
  <p class="text-[14px] mb-4">Durable Faux Leather water-resistant fabric</p>
</section>
...
<main>
  ...
  <script>
    (() => {
      const PRODUCT_NAME = "ASTROGALAXY DLXSV BACKPACK";

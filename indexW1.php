...
<body class="bg-white text-black">
  ...
  <main class="max-w-7xl mx-auto px-10 flex flex-col md:flex-row gap-10">
    <section class="flex flex-col">
      <img id="mainImage" alt="Backpack Front" class="rounded-md max-w-[600px] w-full" src="https://www.sprayground.com/cdn/shop/files/file_cd189763-51e0-4ccd-aa86-7398362a32de.png?v=1748981993"/>
  ...
  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_cd189763-51e0-4ccd-aa86-7398362a32de.png?v=1748981993"
      data-src="https://www.sprayground.com/cdn/shop/files/file_cd189763-51e0-4ccd-aa86-7398362a32de.png?v=1748981993" 
      alt="Front view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_0dfed505-75ce-42d1-9730-4fd0b31a1a38.png?v=1748981993"
      data-src="https://www.sprayground.com/cdn/shop/files/file_0dfed505-75ce-42d1-9730-4fd0b31a1a38.png?v=1748981993" 
      alt="Back view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_4cc95843-6516-4f89-87aa-eefa9ba1dfa7.png?v=1748981997"
      data-src="https://www.sprayground.com/cdn/shop/files/file_4cc95843-6516-4f89-87aa-eefa9ba1dfa7.png?v=1748981997" 
      alt="Side view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_23b64781-3386-45d0-bf77-bcb799157bb2.png?v=1748981998"
      data-src="https://www.sprayground.com/cdn/shop/files/file_23b64781-3386-45d0-bf77-bcb799157bb2.png?v=1748981998" 
      alt="Inside view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_3ae9bc57-2ae0-42c8-a6a8-424645e78eef.jpg?v=1748976796"
      data-src="https://www.sprayground.com/cdn/shop/files/file_3ae9bc57-2ae0-42c8-a6a8-424645e78eef.jpg?v=1748976796" 
      alt="Inside view 2" class="rounded-md max-h-full max-w-full object-contain" />
  </div>
    </section>

    <section class="flex flex-col max-w-md">
      <h1 class="text-[18px] font-normal tracking-widest mb-1">BRICK BOTANIST DLXR BACKPACK</h1>
  ...
  <p class="ml-6 mb-4">900D Polyester Fabric</p>
</div>
  ...
  <script>
    (() => {
      const PRODUCT_NAME = "BRICK BOTANIST DLXR BACKPACK";

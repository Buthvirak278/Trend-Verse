...
<body class="bg-white text-black">
  ...
  <main class="max-w-7xl mx-auto px-10 flex flex-col md:flex-row gap-10">
    <section class="flex flex-col">
      <img id="mainImage" alt="Backpack Front" class="rounded-md max-w-[600px] w-full" src="https://www.sprayground.com/cdn/shop/files/file_1fa05564-fff2-4b28-a5b9-56ea8b614e17.png?v=1748981869"/>
      
      <div class="flex gap-6 mt-6 small-images">
  <button class="border border-black rounded-md p-1 max-w-[100px]">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_1fa05564-fff2-4b28-a5b9-56ea8b614e17.png?v=1748981869"
      data-src="https://www.sprayground.com/cdn/shop/files/file_1fa05564-fff2-4b28-a5b9-56ea8b614e17.png?v=1748981869" 
      alt="Front view" class="rounded-md" />
  </button>

  <button class="border border-black rounded-md p-1 max-w-[100px]">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_d705da0f-069f-4602-8848-bcc277f97985.png?v=1748981873"
      data-src="https://www.sprayground.com/cdn/shop/files/file_d705da0f-069f-4602-8848-bcc277f97985.png?v=1748981873" 
      alt="Back view" class="rounded-md" />
  </button>

  <button class="border border-black rounded-md p-1 max-w-[100px]">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_e7c0982c-e1cc-432e-92ed-dc27e540a79d.png?v=1748981871"
      data-src="https://www.sprayground.com/cdn/shop/files/file_e7c0982c-e1cc-432e-92ed-dc27e540a79d.png?v=1748981871" 
      alt="Side view" class="rounded-md" />
  </button>

  <button class="border border-black rounded-md p-1 max-w-[100px]">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_a0bf39c1-b18b-4cde-8409-f11e44d11e07.png?v=1748981868"
      data-src="https://www.sprayground.com/cdn/shop/files/file_a0bf39c1-b18b-4cde-8409-f11e44d11e07.png?v=1748981868" 
      alt="Inside view" class="rounded-md" />
  </button>
  <button class="border border-black rounded-md p-1 max-w-[100px]">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_b332f82a-7dc6-42b1-a421-1891b4fd1cb5.jpg?v=1748981868"
      data-src="https://www.sprayground.com/cdn/shop/files/file_b332f82a-7dc6-42b1-a421-1891b4fd1cb5.jpg?v=1748981868" 
      alt="Inside view" class="rounded-md" />
  </button>
</div>
    </section>
    ...
    <section class="flex flex-col max-w-md">
      <h1 class="text-[18px] font-normal tracking-widest mb-1">SHARK CENTRAL PULSE BACKPACK</h1>
...
<section class="max-w-7xl mx-auto px-10 mt-10">
  ...
  <p class="text-[14px] mb-6">Nylon with new thin rubber mouth details</p>
  ...
  <p class="text-[14px] mb-4">100% Nylon</p>
</section>
  ...
  <script>
    (() => {
      const PRODUCT_NAME = "SHARK CENTRAL PULSE BACKPACK";

...
<body class="bg-white text-black">
  ...
  <main class="max-w-7xl mx-auto px-10 flex flex-col md:flex-row gap-10">
    <section class="flex flex-col">
      <img id="mainImage" alt="Backpack Front" class="rounded-md max-w-[600px] w-full" src="https://www.sprayground.com/cdn/shop/files/file_2269f40f-b160-48fd-a271-29d974dd3302.png?v=1749485750"/>
  ...
  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_2269f40f-b160-48fd-a271-29d974dd3302.png?v=1749485750"
      data-src="https://www.sprayground.com/cdn/shop/files/file_2269f40f-b160-48fd-a271-29d974dd3302.png?v=1749485750" 
      alt="Front view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_bbe7db6f-9aa6-4dec-810f-a687c817c69e.png?v=1749485749"
      data-src="https://www.sprayground.com/cdn/shop/files/file_bbe7db6f-9aa6-4dec-810f-a687c817c69e.png?v=1749485749" 
      alt="Back view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_ad2a86b8-b2a1-4f65-b044-abf5f885c533.png?v=1749485752"
      data-src="https://www.sprayground.com/cdn/shop/files/file_ad2a86b8-b2a1-4f65-b044-abf5f885c533.png?v=1749485752" 
      alt="Side view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_a7811336-be6b-4d3b-a5be-87dfa495123d.png?v=1749485757"
      data-src="https://www.sprayground.com/cdn/shop/files/file_a7811336-be6b-4d3b-a5be-87dfa495123d.png?v=1749485757" 
      alt="Inside view" class="rounded-md max-h-full max-w-full object-contain" />
  </div>

  <div class="border border-black rounded-md p-1 w-24 h-24 flex items-center justify-center cursor-pointer">
    <img 
      src="https://www.sprayground.com/cdn/shop/files/file_f2f577d8-0675-4d81-99f3-c20e6599ea4f.png?v=1749485754"
      data-src="https://www.sprayground.com/cdn/shop/files/file_f2f577d8-0675-4d81-99f3-c20e6599ea4f.png?v=1749485754" 
      alt="Inside view 2" class="rounded-md max-h-full max-w-full object-contain" />
  </div>
    </section>

    <section class="flex flex-col max-w-md">
      <h1 class="text-[18px] font-normal tracking-widest mb-1">ABEARICAN SUCCESS DLXR BACKPACK</h1>
...
<section class="px-6 py-8 bg-gray-50">
  ...
  <script>
    (() => {
      const PRODUCT_NAME = "ABEARICAN SUCCESS DLXR BACKPACK";
      ...
      showAllBtn.onclick = () => alert("Redirecting to all items...");
